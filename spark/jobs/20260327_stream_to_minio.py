...
# Schéma Avro (Identique au générateur)
json_schema = """
{
  "type": "record",
  "name": "SportActivity",
  "namespace": "com.poc.sport",
  "fields": [
...
# LOGIQUE DE DÉCISION DU MODE
if SPARK_MODE == "BATCH":
    print(">>> MODE BATCH DÉTECTÉ : Traitement de l'historique disponible...")
    # Trigger availableNow traite tout et s'arrête
    query = writer.trigger(availableNow=True).start()
else:
    print(">>> MODE STREAMING DÉTECTÉ : En attente de données...")
